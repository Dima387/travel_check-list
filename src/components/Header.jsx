    ...
    return(
        ...
        <header className="sticky top-0 z-50 bg-slate-950/95 border-b border-slate-800 shadow-[0_1px_30px_-20px_rgba(0,0,0,0.8)] h-20 flex items-center px-8">
            ...
            <div className="flex-1 mx-10">
                <div className="relative max-w-xl mx-auto">
                    ...
                    <input
                        ...
                        className="h-12 w-full rounded-2xl border border-slate-800 bg-slate-900/90 px-12 text-slate-100 outline-none ring-1 ring-slate-900 focus:ring-cyan-500/40"
                    />
                </div>
            </div>
            ...
            <div className="flex items-center gap-4 h-12">
                ...
                <div className="flex h-12 items-center rounded-full bg-slate-900/80 border border-slate-800 p-1">
                    <img src="/img/user.png" alt="User avatar" className="h-11 w-11 rounded-full bg-slate-800" />
                </div>
                <button
                    onClick={handleLogout}
                    className="inline-flex h-12 items-center rounded-2xl border border-cyan-500/40 bg-slate-900/90 px-4 text-sm text-cyan-300 hover:bg-slate-800"
                >
